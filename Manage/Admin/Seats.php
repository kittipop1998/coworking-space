...
session_start();
	...
	include("../../Model/Dao/seatsDao.php");
	include("../../Model/Logic/seatsLogic.php");
	include("../../Views/Admin/seats/seats_view.php");
	include("../../Controllers/Admin/seatsController.php");
?>
...
<!--------------------------Content----------------------------------------->
  ...
  <?php seatsController::instance()->invoke(); ?>
  </div>
</div>
</body>
</html>