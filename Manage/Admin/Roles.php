...
session_start();
	...
	include("../../Model/Dto/rolesDto.php");
	include("../../Model/Dao/baseDao.php");
	include("../../Model/Dao/usersDao.php");
	include("../../Model/Dao/rolesDao.php");
	include("../../Model/Logic/rolesLogic.php");
	include("../../Views/Admin/roles/roles_view.php");
	include("../../Controllers/Admin/rolesController.php");
?>
...
<!--------------------------Content----------------------------------------->
  ...
  <?php rolesController::instance()->invoke(); ?>
  </div>
</div>
</body>
</html>