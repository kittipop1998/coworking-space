...
session_start();
	...
	include("../../Views/Admin/conferenceroom/conferenceroomtype_view.php");
	include("../../Controllers/Admin/conferenceroomtypeController.php");
?>
...
<!--------------------------Content----------------------------------------->
  ...
  <?php conferenceroomtypesController::instance()->invoke(); ?>
  </div>
</div>
</body>
</html>