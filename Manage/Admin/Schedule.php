...
session_start();
  ...
  include("../../Model/Dao/scheduleDao.php");
  
  include("../../Views/Admin/schedule/ScheduleView.php");
  
  include("../../Controllers/Admin/scheduleController.php");
?>
...
<!--------------------------Content----------------------------------------->
  ...
  <?php scheduleController::instance()->invoke(); ?>
  </div>
</div>
</body>
</html>