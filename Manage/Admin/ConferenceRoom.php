...
session_start();
	...
	include ("../../Model/Dto/conferenceroomsDto.php");
	include ("../../Model/Dto/conferenceroomtypesDto.php");
	
	include ("../../Model/Dao/conferenceroomsDao.php");
	include ("../../Model/Dao/conferenceroomtypesDao.php");
	
	include ("../../Model/Logic/conferenceroomsLogic.php");
	include ("../../Model/Logic/conferenceroomtypesLogic.php");
	
	include ("../../Views/Admin/conferenceroom/conferenceroom_view.php");
	include ("../../Controllers/Admin/conferenceroomController.php");
?>
...
<!--------------------------Content----------------------------------------->
  ...
  <?php conferenceroomController::instance()->invoke(); ?>
  </div>
</div>
</body>
</html>