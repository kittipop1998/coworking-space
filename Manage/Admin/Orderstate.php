...
session_start();
	...
	include("../../Model/Dto/orderstateDto.php");
	include("../../Model/Dao/orderstateDao.php");
	include("../../Model/Logic/orderstateLogic.php");
	include("../../Views/Admin/orderstatus/orderstatus_view.php");
	include("../../Controllers/Admin/orderstateController.php");
?>
...
<!--------------------------Content----------------------------------------->
  ...
  <?php orderstateController::instance()->invoke(); ?>
  </div>
</div>
</body>
</html>