...
<!-----------------------------------------------------------------------------------------------------Content----------------------------------------------->
<div id="content" > 
	<h3>An Awesome Coworking Space</h3>
    ...
    <!---------------------------Seats------------------------>
    	<div id="bookseat">
        	<div class="ui card">
              ...
              <div class="content">
                <a class="header" href="Book.php?action=seats">Seats</a>
     ...
     <!---------------------------Team room------------------------>
        ...
        <div id="teamroomseat" >
        	<div class="ui card">
              ...
              <div class="content">
                <a class="header" href="Book.php?action=teamroom">Team Room</a>
                <div class="description">
     ...
     <!---------------------------Conference room------------------------>
        <div id="conferenceRoom" >
        	<div class="ui card">
              ...
              <div class="content">
                <a class="header" href="Book.php?action=conferenceroom">Conference Room</a>
                <div class="description">
